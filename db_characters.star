...
def render_character_profile(character_info_dict, character_image, planet_image, debug_output):
    ...
    if character_info_dict["name"] != None and len(character_info_dict["name"]) > 0:
        text_array.append(render.Text(content = character_info_dict["name"] + " ", font = "tom-thumb", color = "#FD9346"))
    ...
    if (character_info_dict["gender"] != None and len(character_info_dict["gender"]) > 0) or (character_info_dict["race"] != None and len(character_info_dict["race"]) > 0):
        ...
        text_array.append(render.Text(content = character_text + " ", font = "tom-thumb", color = "#FD7F2C"))

    if character_info_dict["ki"] != None and len(character_info_dict["ki"]) > 0 and character_info_dict["ki"] != "unknown":
        text_array.append(render.Text(content = character_info_dict["ki"] + " ki ", font = "tom-thumb", color = "#FF6200"))
