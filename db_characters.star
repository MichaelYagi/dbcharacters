...
def main(config):
    ...
    return get_info(api_endpoint, debug_output, show_headshot, line_one_color, line_two_color, line_three_color, line_four_color, ttl_seconds)

def get_info(api_endpoint, debug_output, show_headshot, line_one_color, line_two_color, line_three_color, line_four_color, ttl_seconds):
    character_info_dict = {
        "name": None,
        "gender": None,
        "race": None,
        ...
        if dbz_characters_dict != None:
            ...
            if get_character_string != None and type(get_character_string) == "string":
                ...
                if dbz_character_dict != None:
                    ...
                    character_info_dict = get_character_info(dbz_character_dict, debug_output, ttl_seconds)
                    if debug_output:
...
def get_character_info(info_dict, debug_output, ttl_seconds):
